...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.di.cis.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.di.cis.security.DomainUserDetailsService", "createSpringSecurityUser");
