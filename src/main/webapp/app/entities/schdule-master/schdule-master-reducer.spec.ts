...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SCHDULEMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_SCHDULEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SCHDULEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SCHDULEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SCHDULEMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SCHDULEMASTER actions', async () => {
      const expectedActions = [
        {
