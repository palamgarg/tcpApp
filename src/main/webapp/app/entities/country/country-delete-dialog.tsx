...
export const CountryDeleteDialog = () => {
  ...
  const countryEntity = useAppSelector(state => state.cis.country.entity);
  const updateSuccess = useAppSelector(state => state.cis.country.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cisApp.country.delete.question">
        <Translate contentKey="cisApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
