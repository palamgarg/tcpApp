...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POLICYMASTER_LIST actions', async () => {
    ...
    it('dispatches FETCH_POLICYMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_POLICYMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_POLICYMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_POLICYMASTER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_POLICYMASTER actions', async () => {
      const expectedActions = [
        {
