...
const EntitiesMenu = () => {
  return (
    <>
      ...
      <MenuItem icon="asterisk" to="/policy-master">
        <Translate contentKey="global.menu.entities.policyMaster" />
      </MenuItem>
      <MenuItem icon="asterisk" to="/schdule-master">
        <Translate contentKey="global.menu.entities.schduleMaster" />
      </MenuItem>
